...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6">
    ...
    <div class="bg-white shadow-md rounded-2xl p-6 hover:shadow-xl transition">
        ...
        <a href="{{ route('dashboard') }}" class="mt-3 inline-block text-[#0a2a4d] font-semibold hover:underline">
            Go Home →
        </a>
    </div>
    ...
    <div class="bg-white shadow-md rounded-2xl p-6 hover:shadow-xl transition">
        ...
        <a href="{{ route('disposable') }}" class="mt-3 inline-block text-[#0a2a4d] font-semibold hover:underline">
            Go to Storage →
        </a>
    </div>
    ...
    <div class="bg-white shadow-md rounded-2xl p-6 hover:shadow-xl transition">
        ...
        <a href="{{ route('records') }}" class="mt-3 inline-block text-[#0a2a4d] font-semibold hover:underline">
            View Records →
        </a>
    </div>
